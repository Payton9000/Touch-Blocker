...
public class ProfilePointTest {
    ...
    @Test
    public void naturalAnchorSurvivesPointCopyOperations() {
        ProfilePoint point = ProfilePoint.enabledWithNaturalAnchor(
                2, "full", 0.1f, 0.9f, 0.4f, 0.7f, 30L, 40L, 5L);

        assertTrue(point.hasNaturalAnchor());
        assertEquals(0.4f, point.getNaturalU(), 0f);
