...
public class ManagePointsActivity extends AppCompatActivity {
    ...
    private void refreshProfile() {
        ...
        ActiveProfiles.Active active = ActiveProfiles.ensure(loaded.getDocument(), currentSnapshot);
        if (active == null) {
    ...
    private void clearProfile() {
        ...
        pointAdapter.submit(new ArrayList<ProfilePoint>(), 48f);
    }
    ...
    private void renderProfile() {
        ...
        globalSizeSlider.setValue(activeProfile.getGlobalDiameterDp());
        renderGlobalSize(activeProfile.getGlobalDiameterDp());
